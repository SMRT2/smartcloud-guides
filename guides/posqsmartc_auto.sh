...
wget https://github.com/telostia/smartcloud-guides/raw/master/wallet/linux64/smartcloud-linux.tar.gz
tar -xvf smartcloud-linux.tar.gz
rm smartcloud-linux.tar.gz
chmod +x smartcloud*
chmod +x smrtc*
#cp smrtc* /usr/local/bin
rm posqsmartc_auto.sh
#rm smrtc*
ufw allow 9887/tcp
...
\nrpcuser=smartcuser$USER\nrpcpassword=$PASSW\ndaemon=1\nlisten=1" >  $HOME/.smartcloud/smartcloud.conf

./smartcloudd
watch ./smartcloud-cli getinfo
